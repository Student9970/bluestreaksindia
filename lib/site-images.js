...
export const SITE_IMG = {
  ...
  // Automotive & mobility
  showroom: (w, h) => unsplash("photo-1583427053896-00378e61e661", w, h),
  ...
  strategyPlanning: (w, h) =>
    unsplash("photo-1454165804606-c3d57bc86b40", w, h),
  documentsDesk: (w, h) => unsplash("photo-1450101499163-c8848c66ca85", w, h),
  signingAgreement: (w, h) =>
    unsplash("photo-1521791136064-7986c2920216", w, h),
  estateKeys: (w, h) => unsplash("photo-1560518883-ce09059eeffa", w, h),
  wealthAdvisory: (w, h) => unsplash("photo-1554224155-6726b3ff858f", w, h),
  wealthPreservation: (w, h) =>
    unsplash("photo-1618044733300-9472054094ee", w, h),
  ipInnovation: (w, h) => unsplash("photo-1504384308090-c894fdcc538d", w, h),

  // People & corporate culture
  executiveMeeting: (w, h) =>
    unsplash("photo-1600880292089-90a7e086ee0c", w, h),
  teamCollaboration: (w, h) =>
    unsplash("photo-1522071820081-009f0129c71c", w, h),
  clientConsultation: (w, h) => unsplash("photo-1557804506-669a67965ba0", w, h),
  professionalHandshake: (w, h) =>
    unsplash("photo-1556761175-5973dc0f32e7", w, h),
  diverseTeam: (w, h) => unsplash("photo-1556761175-4b46a572b786", w, h),
  boardroomDiscussion: (w, h) =>
    unsplash("photo-1600880292203-757bb62b4baf", w, h),
